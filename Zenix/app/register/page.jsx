...
export default function RegisterPage() {
  ...
  const handleRegister = async (e) => {
    ...
    // Validate password using regex: allow any characters as long as there is at least one letter, one number and length is at least 8.
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50">
      ...
      >
        ...
        <Input
          ...
          validate={(value) => {
            // Skip validation error if empty, letting "isRequired" handle it.
        ...
        />
        <Button type="submit" variant="solid" color="success" className="mt-4 w-full text-white font-semibold">
          Register
        </Button>
      </Form>
      </Card>
